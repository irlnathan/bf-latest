...
module.exports = {
  ...
  setSession: function(req, res) {  
    ...
    if (!req.session.me) return res.json('not yet set');
  ...
  /**
   * Check the provided email address or username and password, and if they
  ...
  logout: function (req, res) {
    ...
    // If the user is already logged out redirect to the root route
